...
/**
 * Service implementation for the Connected cities application.
 * @author Rahul Landge
 *
 */
@Service
public class ConnetedCitiesServiceImpl implements ConnectedCitiesService {
	...
	/**
	 * Checks whether the two cities are connected or not based on the cnfiuration provided.
	 * @param city1
	 * @param ciy2
	 * @return
	...
	/**
	 * Gets the key for a particular value from the spring cache.
	 * @param value
	 * @return
	 */
